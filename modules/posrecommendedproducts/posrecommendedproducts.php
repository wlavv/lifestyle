...
class Posrecommendedproducts extends Module implements WidgetInterface
{
    ...
    public function install()
    {
        ...
        Configuration::updateValue($this->prefixname . '_PRODUCTS', '1,2,3,4,5,6,7,8,9');
        Configuration::updateValue($this->prefixname . '_SORT_BY', 1);
        Configuration::updateValue($this->prefixname . '_ORDER_BY', 1);
        Configuration::updateValue($this->prefixname . '_ITEMS', 1);
        Configuration::updateValue($this->prefixname . '_ITEMS_PER_LG', 1);		        Configuration::updateValue($this->prefixname . '_ITEMS_PER_MD', 2);
        ...
        Configuration::updateValue($this->prefixname . '_ROW', 4);
    ...
    protected function installFixtures()
    {
        ...
        foreach ($languages as $lang){
            $values['content_title'][(int)$lang['id_lang']] = 'Trending Products';
