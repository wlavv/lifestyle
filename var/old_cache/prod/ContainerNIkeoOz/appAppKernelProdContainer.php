...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pJ8sydUJjr', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-RiAu+6WEg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                53 => 'posstaticblocks',
                54 => 'posnewproducts',
                55 => 'posrecommendedproducts',
                56 => 'posstaticfooter',
                57 => 'posthemeoptions',
                58 => 'posfeaturedproducts',
                59 => 'postabcateslider',
                60 => 'poslistcategories',
                61 => 'poslogo',
                62 => 'posslideshows',
                63 => 'blockwishlist',
                64 => 'autoupgrade',
