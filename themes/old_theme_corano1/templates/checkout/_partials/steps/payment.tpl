    ...
    {foreach from=$payment_options item="module_options"}
      {foreach from=$module_options item="option"}
        <div>
          <div id="{$option.id}-container" class="payment-option clearfix">
            ...
            <label for="{$option.id}">
              ...
              {*{if $option.logo}
                <img loading="lazy" src="{$option.logo}">
              {/if}*}
            </label>
        ...
        {if $option.additionalInformation}
          <div
            id="{$option.id}-additional-information" class="js-additional-information definition-list additional-information{if $option.id != $selected_payment_option} ps-hidden {/if}" style="margin: 2.25rem">
        ...
        {foreach from=$conditions_to_approve item="condition" key="condition_name"}
          <li>
            ...
            <div class="condition-label">
                <label>
                    Concordo com os <a target="_blank" href="https://life-style.pt/content/3-termos-e-condicoes">termos do serviço</a> e aceito-os incondicionalmente.
                </label>
