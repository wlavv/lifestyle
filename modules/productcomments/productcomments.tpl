...
<div id="product_comments_block_tab"> 
  ...
  <p class="align_center">
	 <a id="new_comment_tab_btn" class="open-comment-form btn btn-secondary" >{l s='Write your review' mod='productcomments'} !</a>
  </p>
  {/if}
  {else}
  {if (!$too_early AND ($logged OR $allow_guests))}
  <p class="align_center">
	 <a id="new_comment_tab_btn" class="btn btn-secondary" data-toggle="modal" data-target="#myModal">{l s='Be the first to write your review' mod='productcomments'} !</a>
  </p>
  {else}
...
{if isset($product_tab) && $product_tab}
<div class="container">
                  ...
                  <form id="id_new_comment_form" action="#">
					 ...
					 <div class="row">
						 ...
						 <div class="product clearfix col-xs-12 col-sm-6">
							<img src="{$productcomment_cover_image}" alt="{$product_tab->name|escape:html:'UTF-8'}" />
							<div class="product_desc">
							   <p class="product_name"><strong>{$product_tab->name}</strong></p>
							</div>
						 </div>
						 {/if}
						 <div class="new_comment_form_content col-xs-12 col-sm-6">
							...
							<div id="new_comment_form_footer">
							   ...
							   <p class="fl required" style="margin-bottom:10px;"><sup>*</sup> {l s='Required fields' mod='productcomments'}</p>
							   <p class="fr">
								  <button id="submitNewMessage" class ="btn btn-secondary" name="submitMessage" type="submit">{l s='Send' mod='productcomments'}</button>
								  &nbsp;
								{l s='or' mod='productcomments'}&nbsp;
							   <button type="button" class="closefb btn btn-secondary" data-dismiss="modal" aria-label="Close">
								  <span aria-hidden="true">{l s='Cancel' mod='productcomments'}</span>
								</button>
							   </p>
							   <div class="clearfix"></div>
							</div>
   ...
   <div class="modal fade" id="result_comment" role="dialog">
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-body">
               <h2>{l s='Your comment is submitted' mod='productcomments'}</h2>
            </div>
         </div>
      </div>
   </div>
