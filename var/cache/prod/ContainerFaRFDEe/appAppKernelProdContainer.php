...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('fS1vUIUG21', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'playfunc_mStore', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setNamingStrategy(($this->services['prestashop.database.naming_strategy'] ?? ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('psrq_'))));
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('psrq_');
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bIx9NoTcKZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C5vd3yDB7F', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4FTV1mXFzs', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zLhx4dUTM3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vYAaVZb0uR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aFf9AyBvQV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gZiRMKC1Md', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EbJ5izOrBl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2p2Dy1HRlf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('0lhWH+N+ri', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nJJYDK3Pjl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZQnrtNw2kp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FXOucaMj2r', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VeQLZmv4l-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('gaawnrjnszmlmgmjbjcgfllmnowvcils3sdoyij6kgmynpkfprchmfle'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                14 => 'ps_faviconnotificationbo',
                15 => 'ps_languageselector',
                16 => 'ps_linklist',
                17 => 'ps_searchbar',
                18 => 'ps_sharebuttons',
                19 => 'ps_shoppingcart',
                ...
                22 => 'ps_wirepayment',
                23 => 'pagesnotfound',
                24 => 'statsbestcategories',
                25 => 'statsbestcustomers',
                26 => 'statsbestproducts',
                ...
                51 => 'posstaticblocks',
                52 => 'posnewproducts',
                53 => 'posrecommendedproducts',
                54 => 'posstaticfooter',
                55 => 'posthemeoptions',
                56 => 'posfeaturedproducts',
                57 => 'postabcateslider',
                58 => 'poslistcategories',
                59 => 'postestimonials',
                60 => 'poslogo',
                61 => 'xipblog',
                62 => 'xipblogdisplayposts',
                63 => 'posslideshows',
                64 => 'blockwishlist',
                65 => 'ps_specials',
                66 => 'ps_newproducts',
                67 => 'ps_distributionapiclient',
                68 => 'autoupgrade',
            ],
            ...
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQCxjFiFMUkWF2iv'."\n".'gp/b90xYdxZwLXzYlshDgO4McgYdilmAnF1/TEK6BSpW1Ehcj7oDsJWOHdWwCmaR'."\n".'5j8M3G2YVsoLEPZMZZXvtJcV7akoVBt91aZ+p2897nUIfYRfXApnJKh5ywRy7G0t'."\n".'AogdAWCKIHNTpbqQbj3eFkfI7s3qKQd84ZzImLJZtID7XYc0pT876Ngf/ah5xCS5'."\n".'bppbmU3Ntp/8d4bLWL08oDuG9NGKQQtevx1aH+Su2LKlFXAD3L8FgIQNOfCsUq7c'."\n".'cafN6ixsNJG77bp35gcXd7mSrTaeT4b2DhlT+07nrS2C0QIFokdI2XWsW36kiqot'."\n".'hbtTIHUNAgMBAAECggEAMWHLrSAMJ+zS3R4DwHaD8YcN4p2EP+mQQdY2X5fHQ6gb'."\n".'RL448xMO7BZLtGLOzY/cOPKAZkq+CHycErBrkPQuN1TMVU+ecZk/nrAn5Z14kxLx'."\n".'ooouCMQhGKSeQIJIsw0yh4WWpmllD2Ha683sdcTQSRrFeNp7jXhcFM01ohlphFr1'."\n".'1Ywm2yCqAqcc32RcY7IHhavqTvgFV/pSk/h5yDGQQ6lRY2TsxRnfQfz+qlsUc6+K'."\n".'9Psn2r4BZyk0TwAcrBpFxGPTWTP3Ya4FeX
=> (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                ...
                38 => (\dirname(__DIR__, 4).'/modules/psgdpr/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/blockreassurance/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/ps_advertising/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/blocktags/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/poscompare/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/productcomments/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/posrotatorimg/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/posmegamenu/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/posstaticblocks/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/posnewproducts/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/posrecommendedproducts/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/posstaticfooter/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/posthemeoptions/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/posfeaturedproducts/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/postabcateslider/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/poslistcategories/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/poslogo/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/xipblog/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/xipblogdisplayposts/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/posslideshows/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/blockwishlist/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/ps_specials/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/ps_newproducts/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/autoupgrade/translations'),
            ],
            ...
            'kernel.secret' => 'gaawnrjnszmlmgmjbjcgfllmnowvcils3sdoyij6kgmynpkfprchmfle',
