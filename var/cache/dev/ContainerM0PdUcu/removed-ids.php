...
return [
    '.1_DoctrineProvider~kh._vFP' => true,
    '.1_LegacyRouteLoaderContainer~NtIRRcp' => true,
    '.1_NativeFileSessionHandler~lxe4Um8' => true,
    '.1_NonceGenerator~z59P1TC' => true,
    '.1_ResolvedFormTypeFactory~oIeI4RS' => true,
    '.1_Serializer~xlYQd8b' => true,
    '.1_ServiceLocator~pHtjfmf' => true,
    '.1_SourceContextProvider~v4P9YUV' => true,
    '.1_Swift_Transport_Esmtp_Auth_CramMd5Authenticator~TbBi6Ak' => true,
    '.1_bool~imaheqQ' => true,
    '.1_~6AQaMzX' => true,
    '.1_~PrQgB9l' => true,
    '.2_ArrayAdapter~kh._vFP' => true,
    '.2_HtmlDumper~z59P1TC' => true,
    '.2_ObjectNormalizer~xlYQd8b' => true,
    '.2_SourceContextProvider~v4P9YUV' => true,
    '.2_Swift_Transport_Esmtp_Auth_LoginAuthenticator~TbBi6Ak' => true,
    '.2_~6AQaMzX' => true,
    '.2_~PrQgB9l' => true,
    '.3_RequestContextProvider~v4P9YUV' => true,
    '.3_Swift_Transport_Esmtp_Auth_PlainAuthenticator~TbBi6Ak' => true,
    '.4_CliContextProvider~v4P9YUV' => true,
    '.4_Swift_Transport_Esmtp_Auth_NTLMAuthenticator~TbBi6Ak' => true,
    '.5_CliDescriptor~v4P9YUV' => true,
    '.6_HtmlDescriptor~v4P9YUV' => true,
