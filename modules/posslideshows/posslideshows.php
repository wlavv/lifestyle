        ...
        for ($i = 1; $i <= 3; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					$slide->description[$language['id_lang']] = '{"1":{"title":"Family Jewelery","display":"0","animation":"6"},"2":{"title":"Collection","display":"0","animation":"7"},"3":{"title":"Designer Jewellry Necklaces-Bracelets-Earings","display":"4","animation":"8"},"4":{"title":"Shop Now","display":"5","animation":"10"}}';
				}elseif($i==2){
					$slide->title = 'slide show2';
					$slide->cap_position = 3;
					$slide->description[$language['id_lang']] = '{"1":{"title":"Diamonds Jewelry","display":"0","animation":"7"},"2":{"title":"Collection","display":"0","animation":"8"},"3":{"title":"Shukra Yogam & Silver Power Silver Saving Schemes.","display":"4","animation":"9"},"4":{"title":"Shop Now","display":"5","animation":"10"}}';
				}elseif($i==3){
					$slide->title = 'slide show3';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"Grace Designer","display":"0","animation":"8"},"2":{"title":"Jewellery","display":"0","animation":"9"},"3":{"title":"Rings, Occasion Pieces, Pandora & More.","display":"4","animation":"7"},"4":{"title":"Shop Now","display":"5","animation":"10"}}';
				}else{
